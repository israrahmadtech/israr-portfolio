            ...
            content: (
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-wrap gap-3 mt-2">
                        <span className="flex items-center gap-1 px-3 sm:px-4 py-1 sm:py-2 bg-violet-100 dark:bg-violet-900 text-violet-700 dark:text-white rounded-full text-xs sm:text-sm font-medium">
                            <FaHtml5 /> HTML
                        </span>
                        <span className="flex items-center gap-1 px-3 sm:px-4 py-1 sm:py-2 bg-violet-100 dark:bg-violet-900 text-violet-700 dark:text-white rounded-full text-xs sm:text-sm font-medium">
                            <FaCss3Alt /> CSS
